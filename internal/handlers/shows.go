...
func CreateShow(c *gin.Context) {
    c.JSON(http.StatusNotImplemented, gin.H{"message": "CreateShow not implemented yet"})
}

func GetShows(c *gin.Context) {
    c.JSON(http.StatusNotImplemented, gin.H{"message": "GetShows not implemented yet"})
}

func GetShow(c *gin.Context) {
    c.JSON(http.StatusNotImplemented, gin.H{"message": "GetShow not implemented yet"})
}

func UpdateShow(c *gin.Context) {
    c.JSON(http.StatusNotImplemented, gin.H{"message": "UpdateShow not implemented yet"})
}

func DeleteShow(c *gin.Context) {
    c.JSON(http.StatusNotImplemented, gin.H{"message": "DeleteShow not implemented yet"})
}
